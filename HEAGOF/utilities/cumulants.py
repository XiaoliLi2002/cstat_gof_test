from HEAGOF.utilities.utilities import poisson, np, pd
from HEAGOF.utilities.cumulants_high_accuracy import main_calculations
import os
...
def expectation(s,n,X,I):
    """
    Compute the conditional expectation approximately
